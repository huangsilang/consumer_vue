<template>
  ...
  <el-form :model="ConsumerPojo" :rules="rules" ref="ConsumerPojo" label-width="78px" class="demo-ConsumerPojo">
    <el-form-item label="姓名" prop="name">
      <el-select v-model="ConsumerPojo.name" placeholder="请选择姓名">
        <el-option label="张漂亮" value="张漂亮"></el-option>
        <el-option label="黄先生" value="黄先生"></el-option>
      </el-select>
    </el-form-item>
    ...
    <el-form-item label="类型" prop="type">
      <el-select v-model="ConsumerPojo.type" placeholder="请选择类型">
        ...
        <el-option label="生活用品" value="6"></el-option>
      </el-select>
    </el-form-item>
    <el-form-item label="是否必须" prop="isMust">
      <el-select v-model="ConsumerPojo.isMust" placeholder="请选择">
        ...
        <el-option label="非必须" value="1"></el-option>
      </el-select>
    </el-form-item>
...
<script>
  ...
  export default {
    data() {
      return {
        note: {
          backgroundImage: "url(/static/images/111.jpg)",
